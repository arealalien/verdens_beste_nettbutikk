        ...
        <>
            <main className="main">
                <section id={ident} className="products view-width">
                    ...
                    <Product productName={"Pink Dress"} productPrice={"$19,99"} productImage={"https://images.unsplash.com/photo-1526511253005-9a4a8cde2956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80"}></Product>
                    <Product productName={"Butterflies & flowers Dress"} productPrice={"$69,99"} productImage={"https://images.unsplash.com/photo-1636517521390-c03f981ea01d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1964&q=80"}></Product>
